...
<?php $component->withAttributes([]); ?>
    ...
    <a href="<?php echo e(route('peminjamanbuku.create')); ?>">
    ...
    <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    <form action="<?php echo e(route('peminjamanbuku.destroy', $item->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('DELETE'); ?>
                        <a href="<?php echo e(route('peminjamanbuku.edit',$item->id)); ?>" class="px-4 py-1 text-sm rounded text-blue-600 border border-blue-500 hover:text-white hover:bg-blue-600"><i class="fas fa-pencil-alt"></i></a>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\perpustakaan\resources\views/admin/pinjam/peminjamanbuku.blade.php ENDPATH**/ ?>